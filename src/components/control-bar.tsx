    ...
    <div className="flex items-center gap-1 sm:gap-1.5 mb-3">
        {isDuringDate && (
          <button
            ...
            className={`inline-flex items-center gap-1 text-[0.7rem] px-2 sm:px-2.5 py-1.5 rounded-md border transition-colors ${
              isLiveUpdate
        ...
        <button
          onClick={onRefresh}
          className="inline-flex items-center gap-1 text-[0.7rem] px-2 sm:px-2.5 py-1.5 rounded-md border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
        >
          <RefreshCw size={12} />
          刷新
        </button>
